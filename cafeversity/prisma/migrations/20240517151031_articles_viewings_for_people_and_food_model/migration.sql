...
CREATE TABLE "new_people_and_food" (
    ...
    "articleList_seeing" BOOLEAN NOT NULL DEFAULT true,
    ...
    "firstText" TEXT NOT NULL DEFAULT 'Ўводзіны да артыкула',
...
INSERT INTO "new_people_and_food" ("article_image_path", "article_text", "article_title", "birthCountry", "birthDay", "birthTown", "birthdayDate", "createdAt", "firstText", "id", "imagePaths", "mainImagePath", "mainText", "mainTitle", "personalImagePath", "personalName", "personalStatus", "personalSurname", "shortTitle") SELECT "article_image_path", "article_text", "article_title", "birthCountry", "birthDay", "birthTown", "birthdayDate", "createdAt", "firstText", "id", "imagePaths", "mainImagePath", "mainText", "mainTitle", "personalImagePath", "personalName", "personalStatus", "personalSurname", "shortTitle" FROM "people_and_food";
