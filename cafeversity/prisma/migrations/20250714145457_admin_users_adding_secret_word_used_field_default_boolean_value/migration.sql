...
CREATE TABLE "new_AdminUsers" (
    ...
    "SecretWordUsed" BOOLEAN NOT NULL DEFAULT false,
    "ResetToken" TEXT,
    "ResetTokenExpiry" DATETIME
);
INSERT INTO "new_AdminUsers" ("Email", "EmailConfirmed", "ID", "Language", "Name", "Password", "Photo", "ResetToken", "ResetTokenExpiry", "Role", "SecretWord", "SentCode", "SessionId", "Surname", "Telephone", "Theme") SELECT "Email", "EmailConfirmed", "ID", "Language", "Name", "Password", "Photo", "ResetToken", "ResetTokenExpiry", "Role", "SecretWord", "SentCode", "SessionId", "Surname", "Telephone", "Theme" FROM "AdminUsers";
