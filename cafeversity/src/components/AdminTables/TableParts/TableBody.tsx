...
type TableBodyProps<T> = {
    ...
    expandedRowsComponent?: ExpandableRowsComponent<T>,
...
const TableBody = <T extends { id: number }>({
    ...
    //     onDelete: () => void
    // }
    // const SubHeaderComponent = ({ onConfirm, onDelete }: SubHeaderComponentProps) => {
        ...
        <div style={{ position: "relative" }}>
            <DataTable
                ...
                expandableRowsComponent={({ data }) => (
                    ...
                    <TableRowExpander initialColumns={initialColumns}
                ...
                noDataComponent={
                    <NoDataComponent tableLoad={tableLoad} data={data} searchType={searchType} />
                }
            />
