...
const RangeInput2Handlers = ({ twohandRangeName = "" }) => {
    ...
    function lowerRangeCheck(event: React.ChangeEvent<HTMLInputElement>) {
        ...
        // setLowerRange(Math.min(lowerRangeNum, upperRange)); // This is the same code as the condition above
    }
    ...
    function upperRangeCheck(event: React.ChangeEvent<HTMLInputElement>) {
        ...
        // setUpperRange(Math.max(upperRangeNum, lowerRange)); // This is the same code as the condition above
    }
