...
import ChooseDishProvider from "@/app/components/CafeManager/OrdersManagement/ChooseDishContext";
import DishesInOrder from "@/app/components/CafeManager/OrdersManagement/DishesInOrder";
import DishesInCafe from "@/app/components/CafeManager/OrdersManagement/DishesInCafe";
        ...
        <ChooseDishProvider>
            <div className="w-[100dvw] h-[85dvh] bg-[whitesmoke] px-[3rem] py-[1.75rem] outline-1 outline-[orange]">
                ...
                <div className="h-[61dvh] w-[100%] flex flex-row">
                    <DishesInOrder orderInfo={orderInfo} />
