...
export default function HomeCafeManagerView({
    ...
    cafeImage, latitude, longitude}: {
    cafeName: string, openHours: string, city: string, street: string, country: string, phone: string,
    cafeImage: string, latitude: string, longitude: string, srid: number
}) {
        ...
        <div className="grid grid-cols-2 grid-rows-3 h-[85dvh] ml-[10rem] mr-[10rem]">
            <GridBlock column="1/3" row={1} style={{
                ...
                <div className="h-[100%] flex items-center justify-between">
                    <ActualTime workdayHours={workdays} saturdayHours={saturday} />
                    <div className="h-[100%] p-[2rem] text-[2rem]">
            ...
            <GridBlock column={1} row={"2/4"} style={{
                ...
                <MapWrapper latitude={latitude.toString()} longitude={longitude.toString()} name={cafeName} />
            </GridBlock>
